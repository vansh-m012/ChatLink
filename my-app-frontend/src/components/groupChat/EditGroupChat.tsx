...
export default function EditGroupChat({
  ...
  user: CustomUser;
  group: ChatGroupType; // type.ts file
  open: boolean;
  ...
  const { register, handleSubmit, setValue, formState: { errors }} = useForm<createChatSchemaType>({
      resolver: zodResolver(createChatSchema),
  });

  // pre-fill the title & passcode bar with prop passed group.title, group.passcode.
  //First render me React ke liye [group] ka previous value undefined hai.
  //Current group = parent se pass hua prop object.
  useEffect(() => {
