...
export default function ChatUserDialog( {open, setOpen, group}:  {open: boolean, setOpen: Dispatch<SetStateAction<boolean>>, group: ChatGroupType}) {
  ...
  useEffect(() => {
    ...
    if (data) {
      console.log("localStorage raw value:", data);
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    // if already localStorage user => Entered wrong passcode
